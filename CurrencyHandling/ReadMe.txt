========================================================================
    DYNAMIC LINK LIBRARY: CurrencyHandling-Projektübersicht
========================================================================

Diese CurrencyHandling-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre CurrencyHandling-Anwendung besteht.


CurrencyHandling.vcxproj
...
CurrencyHandling.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen CurrencyHandling.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
